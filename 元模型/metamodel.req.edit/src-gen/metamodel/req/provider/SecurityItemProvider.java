...
/**
 * This is the item provider adapter for a {@link metamodel.req.Security} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityItemProvider extends Nonfunctional_reqItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Security) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Security_type")
